    ...
    connection.onsuccess = function () {
        ...
        request.onsuccess = (e) => {
            ...
            if (matching) {
                html = `
                <div class="shwBtns">
                    <button class="btn" onclick='editNote(this)' name="${matching.noteid}" data-noteid="${matching.noteid}" onMouseOut="this.style.color='black'" onMouseOver="this.style.color='white'"><i class="fa fa-edit fa-lg"></i></button>
    ...
    connection.onsuccess = function () {
        ...
        request.onsuccess = (e) => {
            ...
            if (matching) {
                ...
                html2 = `
                <div class="shwBtnsR">
                    <button class="btnShow" onclick='editNote(this)' name="${matching.noteid}" data-noteid="${matching.noteid}" onMouseOut="this.style.color='black'" onMouseOver="this.style.color='white'"><i class="fa fa-edit"></i></button>
